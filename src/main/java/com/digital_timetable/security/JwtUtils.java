...
public class JwtUtils {
    ...
    // Absolute JWT expiration: 1 hour (note: this is not activity-based idle timeout)
    private static final long EXPIRATION_TIME_IN_MILLISEC = 1000L * 60L * 60L; // expires in ~1 hour
